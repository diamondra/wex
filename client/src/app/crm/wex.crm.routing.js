appCrm.config(function($routeProvider, $locationProvider, WEX_CONFIG)
{
    ...
    .when('/crm', {
        ...
        templateUrl: '/app/crm/client/views/client-list.html',
    ...
    .when('/crm/client/create', {
        ...
        templateUrl: '/app/crm/client/views/client-edit.html',
    ...
    .when('/crm/project', {
        ...
        templateUrl: '/app/crm/project/views/project-list.html',
		title: 'Liste des projets',
    })
    .when('/crm/project/create', {
        controller: 'ProjectCreateCtrl',
        templateUrl: '/app/crm/project/views/project-edit.html',
